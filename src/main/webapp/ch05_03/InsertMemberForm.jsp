		...
		<table border="1">
			...
			<tbody>
				...
				<tr bgcolor='tan'>
					...
					<td width="600" height="40" align="left"><input name="mPhone" value="${param.mPhone}"
						type="text" size="20"></td>
				</tr>
				<tr bgcolor='tan'>
					<td width="120" height="40">生日:</td>
					<td width="600" height="40" align="left"><input
						name="mBirthday" value="${param.mBirthday}" type="text" size="14">
						<font color='blue'
				...
				<tr bgcolor='tan'>
					...
					<td width="600" height="40" align="left"><input name="mWeight" value="${param.mWeight}"
						type="text" size="14">
