...
<body onload="javascript:document.updataMemberFormB.mId.focus();">
...
<%-- 					<td width="600" height="40" align="left">${param.mId} --%>
<!-- 					</td>	 -->
<!-- 				</tr> -->
				<tr bgcolor='tan'>
					<td width="120" height="40">商品編號:</td>
					<td width="600" height="40" align="left"><input id='num'
						style="text-align: left" name="mId" value="${param.mId}" type="text" size="20" readonly>
				...
				<tr bgcolor='tan'>
					...
					<td width="600" height="40" align="left"><input id='num2'
						style="text-align: left" name="pswd" value="${ memberBean.password }${param.pswd}" type="text" size="20" >
						<div style="color:#FF0000; font-size:60%; display: inline">${ErrorMsg.password}</div>
					</td>
				</tr>
					<tr bgcolor='tan'>
					...
					<td width="600" height="40" align="left"><input id='num3'
						style="text-align: left" name="mName" value="${memberBean.name}${param.mName}" type="text" size="20" >
				...
				<tr bgcolor='tan'>
					...
					<td width="600" height="40" align="left"><input
						name="mAddress" value="${ memberBean.address }${param.mAddress}" type="text" size="20">
						<div style="color:#FF0000; font-size:x-small; display: inline">${ErrorMsg.address}</div>
					</td>
				</tr>
				<tr bgcolor='tan'>
					<td width="120" height="40">國際條碼:</td>
					<td width="600" height="40" align="left"><input name="mPhone" value="${ memberBean.phone }${param.mPhone}"
						type="text" size="20"></td>
				</tr>
				<tr bgcolor='tan'>
					<td width="120" height="40">製造日期:</td>
					<td width="600" height="40" align="left"><input
						name="mBirthday" value="${ memberBean.birthday }${param.mBirthday}" type="text" size="20">
						<font color='blue'
				...
				<tr bgcolor='tan'>
					...
					<td width="600" height="40" align="left"><input name="mWeight" value="${ memberBean.weight }${param.mWeight}"
						type="text" size="20">
