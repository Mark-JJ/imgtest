...
//				}
		        ...
		        OutputStream out = new FileOutputStream("C:\\_JSP\\workspaceH\\imgtest\\src\\main\\webapp\\img\\" + filename); // 定義 OutputStram 輸出位置
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/ch06_02/member40.do");
